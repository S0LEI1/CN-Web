...
let product1 = {
  ma: 1,
  img: "../img/phongkhach/banghe/combo-boc-ghe-luoi-hat-xop-mau-do-hoa-van-co-70x70cm-homeazvn152456315.jpg",
  ten: "iPhone 11",
  gia: "2.290.000₫",
  giagoc: "",
  tlgiam: "",
  qua: "Quà 400.000₫",
  title: "ƯU ĐÃI MBBANK GIẢM 500K",
  hang: "Apple",
  loai: "Điện thoại",
...
$(document).ready(function () {
  function displayProduct(product) {
    let producty =
      ...
      '<li>' + product.gia + '</li>' +
      '<li style="color: red;">' + product.qua + '</li>' +
      '<li>' +
      product.danhgia2 +
